(function(d){var e={trackingClass:"track-changes",changedClass:"changed",events:"change blur"},b={init:function(a){a={settings:d.extend({},e,a),original:b.value.call(this),changed:!1};this.data("trackChanges",a);b.bind.call(this);b.trigger.call(this,"init")},bind:function(){b.unbind.call(this);var a=this.data("trackChanges").settings;this.addClass(a.trackingClass).on(a.events,b.interaction)},unbind:function(){var a=this.data("trackChanges");a&&(a=a.settings,this.removeClass(a.trackingClass).off(a.events,
